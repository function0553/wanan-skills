...
| V2.1 | `versions/v2.1/` | 在 V2.0 基础上完善前端设计决策、项目执行与验收机制，不包含学习与考核模块。 |
| V2.1 特供版 | `versions/v2.1-special/` | 在 V2.1 基础上新增强制学习、阶段考核、`经验学习.md`、历史模块补考和综合学习评分，并针对 Windows 与小白使用场景优化。 |

...
| Learning and assessment | `经验学习.md` + protected `.wanan/assessment-state.json` |
...
- Stable `MOD-NNN` learning-module ID for every meaningful deliverable slice
- Learning weight for every module
